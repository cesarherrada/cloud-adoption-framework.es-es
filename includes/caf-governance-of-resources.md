...
Azure Blueprints permite la asignación coherente de roles y directivas, la aplicación de plantillas de Resource Manager y la implantación de grupos de recursos en varias suscripciones. Al igual que las definiciones de directivas, las definiciones de planos técnicos se guardan en grupos de administración o suscripciones. Las definiciones de directivas están disponibles mediante la herencia para todos los elementos secundarios de la jerarquía de grupos de administración.
