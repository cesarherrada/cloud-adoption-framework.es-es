---
title: Plataformas especializadas para la administración en la nube
description: Use Cloud Adoption Framework para Azure con el fin de mejorar las operaciones de administración en la nube específicas de la plataforma, incluida la mejora del diseño del sistema y la corrección automatizada.
