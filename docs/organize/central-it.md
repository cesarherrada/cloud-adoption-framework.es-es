...
description: Use Cloud Adoption Framework para Azure con el fin de aprender a establecer un equipo de TI centralizado para el trabajo de adopción de la nube.
