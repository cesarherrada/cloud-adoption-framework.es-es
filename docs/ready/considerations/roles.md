...
description: Aprenda a separar los deberes en el equipo y a conceder el control de acceso basado en rol para que los usuarios y los grupos puedan realizar su trabajo.
author: rotycenh
ms.author: brblanch
ms.date: 11/28/2018
ms.topic: guide
