...
description: Use Cloud Adoption Framework para Azure con el fin de aprender a identificar las capacidades de red que la zona de aterrizaje necesita para admitir las cargas de trabajo de Azure.
