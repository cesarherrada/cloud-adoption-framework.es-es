...
description: Información sobre la capacitación para la adopción con Azure
author: absheik
ms.author: absheik
ms.date: 10/17/2019
ms.topic: guide
...
**Consulte la [documentación de Azure DevOps Projects](https://docs.microsoft.com/azure/devops-project)**
