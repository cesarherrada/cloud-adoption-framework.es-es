...
description: Use Cloud Adoption Framework para Azure para comprender las opciones de asociación y los enfoques de respaldo a los costos de migración.
