...
Para más información sobre el etiquetado, consulte las [convenciones de nomenclatura del Centro de arquitectura de Azure para los recursos de Azure](../../ready/azure-best-practices/naming-and-tagging.md#metadata-tags).
